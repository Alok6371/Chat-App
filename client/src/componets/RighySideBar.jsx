  ...
  return selectedUser && (
    <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}>
      <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
        <img
          src={selectedUser?.profilePic || 'https://res.cloudinary.com/dn3kbrwp9/image/upload/avatar_icon_mvclg6.png'}
          alt="Profile Pic"
      ...
      <button className='absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-400 to-violet-600 tet-white border-none text-sm  py-2 px-20 rounded-full cursor-pointer font-semibold '>
        Logout
      </button>
    </div>
  ); 
